...
If result > 0 Then
    ...
    ' Рисуем основание дома (прямоугольник)
    ...
    ' Рисуем крышу
    ' Рисуем левый скат
    result = Graphic.CreateLine(sheetId, baseX, baseY + houseHeight, baseX + houseWidth/2, baseY + houseHeight + roofHeight)
    ' Рисуем правый скат
    result = Graphic.CreateLine(sheetId, baseX + houseWidth/2, baseY + houseHeight + roofHeight, baseX + houseWidth, baseY + houseHeight)
    ...
    ' Крона дерева (три круга разного размера)
