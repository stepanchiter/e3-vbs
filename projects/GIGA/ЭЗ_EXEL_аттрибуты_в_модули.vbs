...
Const EXCEL_FILE_PATH_DEFAULT = "C:\Users\SEK\Desktop\DWG_4_E3\Новая папка\ОДНОЛИН\ЗИС\ПРИНЦИП\ЩУ2\запись атрибутов в модули.xlsx" ' Ваш путь к файлу Excel по умолчанию
