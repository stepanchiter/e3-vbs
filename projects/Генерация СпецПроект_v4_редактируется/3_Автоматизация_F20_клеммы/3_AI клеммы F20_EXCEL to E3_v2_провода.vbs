...
' ===============================================================
app.PutInfo 0, "==============================="
app.PutInfo 0, "Модули AI. ШАГ 1 из 4"
app.PutInfo 0, "==============================="
k_modAI8 = 0
k_modAI16 = 0
k_modAO8 = 0
...
' ===============================================================
app.PutInfo 0, "Модули AI. ШАГ 2 из 4"
app.PutInfo 0, "==============================="
...
' ===============================================================
app.PutInfo 0, "Модули AI. ШАГ 3 из 4"
app.PutInfo 0, "==============================="
Redim ArrDeviceIds_11(kanalItog+10, 17)
l = 0
...
For l = 0 To kanalItog-1
	...
	A0 = ArrDeviceIds_10(l, 0)				' "Имя жилы провода" - "Провода" или Поз. обоз. кабеля
	A1 = ArrDeviceIds_10(l, 1)				' "Марка провода" - Наименование на схеме
	A2 = ArrDeviceIds_10(l, 2)				' "Поз.обоз 1" - Откуда
	A3 = ArrDeviceIds_10(l, 3)				' "Поз.обоз 1" - Вывод1 - Откуда
	A4 = ArrDeviceIds_10(l, 4)				' "Позиционное обозначение (Вариант надписи)" для модулей контроллера
	A6 = ArrDeviceIds_10(l, 6)				' "Поз.обоз 2" - куда
	A7 = ArrDeviceIds_10(l, 7)				' "Поз.обоз 2" - Вывод2 - куда
	A8 = ArrDeviceIds_10(l, 8)				' "Имя цепи"
	
	A9 = ArrDeviceIds_10(l, 9)				' Наименование изделия 1 в Е3
	A10 = ArrDeviceIds_10(l, 10)			' Номер страницы
	A11 = ArrDeviceIds_10(l, 11)			' 0 или 1,Использование
...
'--------------------------------------------------------------------------------------------
app.PutInfo 0, "Модули AI. ШАГ 4 из 4"
app.PutInfo 0, "==============================="
