...
' ===============================================================
' Находим все изделия типа "МОДУЛЬ КОНТРОЛЛЕРА DO"
' ===============================================================
app.PutInfo 0, "==============================="
app.PutInfo 0, "Модули DO. ШАГ 1 из 4"
app.PutInfo 0, "==============================="
k_modDI32 = 0
...
For deviceIndex = 1 To deviceCnt
	...
	If InStr(1, deviceNam, "DO", 1) Then
	symbolFilter = 0
	...
	app.PutInfo 0, "Device " & deviceName & " ( " & deviceId & " ) has " & result & " symbols: "
		...
		result5 = sheet.GetName
			If result4 = "R500_DO_32_012-000-AAA_1" Or result4 = "R500_DO_32_012-000-AAA_2" Or result4 = "R500_DO_32_012-000-AAA_3"  Or result4 = "R500_DO_32_012-000-AAA_4" Then 
...
' ===============================================================
k_modDO32 = k_modDO32 * 32 / 4 ' кол-во символов контроллера умножаем на 32 входа, делим на 4 символа
...
' ===============================================================
app.PutInfo 0, "Модули DO. ШАГ 2 из 4"
app.PutInfo 0, "==============================="
...
' ===============================================================
app.PutInfo 0, "Модули AI, AO. ШАГ 3 из 4"
app.PutInfo 0, "==============================="
...
'	A15 = ArrDeviceIds_11(l, 15)			' PIN 1 - "ПЛК - Тип сигнала"
		...
		For j = 0 To k_KL_1
			...
			If A6 = KL1 And A7 = KL2 Then
				If A9 = "Модуль_32DO_R500_DO_32_012-000-AAA" Then 
...
For i = 0 To j-1
	...
	If A4 = "DO" Then 
		...
		ArrDeviceIds_ExcelDO(kDO_0, 1) = A2 				' (5) Описание сигнала / TAG discription
		ArrDeviceIds_ExcelDO(kDO_0, 2) = A3 				' (6) Внешнее подключение / Field connection
		ArrDeviceIds_ExcelDO(kDO_0, 3) = A4 				' (7) Тип сигнала / Signal type
		ArrDeviceIds_ExcelDO(kDO_0, 4) = 0 					' если 0 - можно испоьзовать, 1 - уже использован
		ArrDeviceIds_ExcelDO(kDO_0, 5) = 0 					' id клеммы
		ArrDeviceIds_ExcelDO(kDO_0, 6) = 0 					' id клеммы
		kDO_0 = kDO_0 + 1
	End If 
...
'================================================================================================
For i = 0 To kDO_0 - 1
		D1 = ArrDeviceIds_ExcelDO(i, 0)					' (1) Позиционное обозначение / Position TAG
		D2 = ArrDeviceIds_ExcelDO(i, 1)					' (3) Описание сигнала / TAG discription
		D3 = ArrDeviceIds_ExcelDO(i, 2)					' (4) Внешнее подключение / Field connection
		D4 = ArrDeviceIds_ExcelDO(i, 3)					' (5) Тип сигнала / Signal type
		D5 = ArrDeviceIds_ExcelDO(i, 4)					' если 0 - можно испоьзовать, 1 - уже использован
					...
					If InStr(1, KL10, "XT", 1) Then
						...
						If E5 <> "" And E6 <> "" And E13 <> "" And E14 <> "" Then 
							If A3_5_1 <> "" And A3_5_2 <> "" And A3_7_1 <> "" And A3_7_2 <> ""Then 
								If KL10 = E5 And KL20 = E6 And E18 = terminalId Then 
									result11 = dev.SetName( A3_5_1 )
									result12 = dev.SetMasterPinName( A3_5_2 )
									ArrDeviceIds_ExcelDO(i, 4) = 1
									ArrDeviceIds_11(j, 11) = 1
									ArrDeviceIds_ExcelDO(i, 5) = 1
								End If 
		
									If KL10 = E13 And KL20 = E14 And E19 = terminalId Then 
									result13 = dev.SetName( A3_7_1 )
									result14 = dev.SetMasterPinName( A3_7_2 )
									ArrDeviceIds_ExcelDO(i, 4) = 1
									ArrDeviceIds_11(j, 11) = 1
									ArrDeviceIds_ExcelDO(i, 6) = 1
								End If 
							End If 
...
'								End If 
							End If 
								...
								If ArrDeviceIds_ExcelDO(i, 5) = 1 And ArrDeviceIds_ExcelDO(i, 6) = 1 Then  
									Exit For
								End If 
